...
<div class="container mt-4">
  <a href="{{ url('/admin/event/add') }}"><button type="button" class="btn btn-primary" style="float: right;">Add Event</button></a>
    ...
    <table class="table table-bordered table-striped" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <a href="{{ url('/admin/event/edit/' . $event->id) }}" class="edit" title="" data-toggle="tooltip" data-original-title="edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                  <a href="javascript:void(0);" class="delete deleteEvent" title="" data-id="{{$event->id}}" data-toggle="modal" data-original-title="Delete" data-target="#delete"><i class="fa fa-trash"></i></a>

                  <a href="{{ url('/admin/event/booking/'.$event->id) }}"><button type="button" class="btn btn-success">Show Bookings</button></a>
                </td>
            </tr>
            @endforeach
        </tbody>
